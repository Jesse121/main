 ...
 *
 */
export function queryChildSysEnum(data: QueryChildSysEnumParams, config?: Record<string, any>): Promise<BaseRes<QueryChildSysEnumData>> {
	
	return request({
		url: import.meta.env.VITE_APP_MOCK === 'true' ? `http://192.168.137.35:3000/mock/224/api/queryChildSysEnum` : `/api/queryChildSysEnum`,
		method: "post",
		data,
		...config
	}) as any;
 ...
 *
 */
export function queryOwnArea(data: QueryOwnAreaParams, config?: Record<string, any>): Promise<BaseRes<QueryOwnAreaData>> {
	
	return request({
		url: import.meta.env.VITE_APP_MOCK === 'true' ? `http://192.168.137.35:3000/mock/224/api/queryOwnArea` : `/api/queryOwnArea`,
		method: "post",
		data,
		...config
	}) as any;
 ...
 *
 */
export function queryAreaByNameAndCode(data: QueryAreaByNameAndCodeParams, config?: Record<string, any>): Promise<BaseRes<QueryAreaByNameAndCodeData>> {
	
	return request({
		url: import.meta.env.VITE_APP_MOCK === 'true' ? `http://192.168.137.35:3000/mock/224/api/queryAreaByNameAndCode` : `/api/queryAreaByNameAndCode`,
		method: "post",
		data,
		...config
	}) as any;
 ...
 *
 */
export function queryOwnAreaBycode(data: QueryOwnAreaBycodeParams, config?: Record<string, any>): Promise<BaseRes<QueryOwnAreaBycodeData>> {
	
	return request({
		url: import.meta.env.VITE_APP_MOCK === 'true' ? `http://192.168.137.35:3000/mock/224/api/queryOwnAreaBycode` : `/api/queryOwnAreaBycode`,
		method: "post",
		data,
		...config
	}) as any;
 ...
 *
 */
export function queryChildAreaBycode(data: QueryChildAreaBycodeParams, config?: Record<string, any>): Promise<BaseRes<QueryChildAreaBycodeData>> {
	
	return request({
		url: import.meta.env.VITE_APP_MOCK === 'true' ? `http://192.168.137.35:3000/mock/224/api/queryChildAreaBycode` : `/api/queryChildAreaBycode`,
		method: "post",
		data,
		...config
	}) as any;
 ...
 *
 */
export function queryParentAreaBycode(data: QueryParentAreaBycodeParams, config?: Record<string, any>): Promise<BaseRes<QueryParentAreaBycodeData>> {
	
	return request({
		url: import.meta.env.VITE_APP_MOCK === 'true' ? `http://192.168.137.35:3000/mock/224/api/queryParentAreaBycode` : `/api/queryParentAreaBycode`,
		method: "post",
		data,
		...config
	}) as any;
 ...
 *
 */
export function queryChildArea(data: QueryChildAreaParams, config?: Record<string, any>): Promise<BaseRes<QueryChildAreaData>> {
	
	return request({
		url: import.meta.env.VITE_APP_MOCK === 'true' ? `http://192.168.137.35:3000/mock/224/api/queryChildArea` : `/api/queryChildArea`,
		method: "post",
		data,
		...config
	}) as any;
...
export function getBaseInfo(data: BaseInfoParams, config?: Record<string, any>): Promise<BaseRes<BaseInfoData>> {
	const { id } = data;
	return request({
		url: import.meta.env.VITE_APP_MOCK === 'true' ? `http://192.168.137.35:3000/mock/224/api/web/getBaseInfo` : `/api/web/getBaseInfo`,
		method: "get",
		params: { id },
		...config
	}) as any;
...
export function appLogin(data: AppLoginParams, config?: Record<string, any>): Promise<AppLoginData> {
	...
	return request({
		url: import.meta.env.VITE_APP_MOCK === 'true' ? `http://192.168.137.35:3000/mock/224/api/login` : `/api/login`,
		method: "post",
		data,
		...config
	}) as any;
...
export function login(data: LoginParams, config?: Record<string, any>): Promise<LoginData> {
	...
	return request({
		url: import.meta.env.VITE_APP_MOCK === 'true' ? `http://192.168.137.35:3000/mock/224/api/web/login` : `/api/web/login`,
		method: "post",
		data,
		...config
	}) as any;
 ...
 *
 */
export function refreshToken(data: RefreshTokenParams, config?: Record<string, any>): Promise<BaseRes<RefreshTokenData>> {
	const { refreshToken } = data;
	return request({
		url: import.meta.env.VITE_APP_MOCK === 'true' ? `http://192.168.137.35:3000/mock/224/api/refreshToken` : `/api/refreshToken`,
		method: "post",
		params: { refreshToken },
		...config
	}) as any;
...
export function logout(data: LogoutParams, config?: Record<string, any>): Promise<LogoutData> {
	const { token } = data;
	return request({
		url: import.meta.env.VITE_APP_MOCK === 'true' ? `http://192.168.137.35:3000/mock/224/api/logout` : `/api/logout`,
		method: "post",
		params: { token },
		...config
	}) as any;
